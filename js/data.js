...
const DATA = {
  ...
  "missions": {
    ...
    "unlock": {
      "conditions": [
        "계정(오퍼레이션) 레벨 17 달성",
        "롱보우(정규)에서 낚시꾼 NPC 조 리드와 대화 > 대화 후 수락 > 매치종료 후 우편으로 첫 낚싯대 획득",
  ...
  "npc": {
    ...
    "imageSource": "인게임 캡처",
    "spawnRule": "한 매치에 롱보우(정규) 낚시터 3곳 중 1곳에 랜덤 스폰. 그로브 베이(고요한 만) 집 주변이 스폰 지점 중 하나로 확인됨. 누군가 NPC를 죽이면 그 매치에서는 더 이상 등장하지 않음.",
    "spawnSpots": [
      {
