...
const DATA = {
  ...
  "fish": [
    ...
    },
    {
      ...
      "tips": "그로브 베이 유일 출현(조 리드 집 근처, 맵 좌상단). 줄을 멀리 끌지 않는 대신 순간 장력이 급상승하는 타입 — 장력 레드존 주의. 4000D 헤비 드래그 릴 해금 트레이드 요구 무게: 6kg."
    },
    {
      "id": "bigeye-tarpon",
  ...
  "missions": {
    ...
    "certifications": [
      ...
      },
      {
        ...
        "requirement": "기준 무게를 넘는 숭어·파이크퍼치(잰더) 각 1마리 제출 — 조 리드 옆 통발에 물고기를 넣은 뒤 대화 → '물고기 제출'",
        "reward": "금속 루어 낚싯대",
  ...
  "gear": {
    ...
    "rods": [
      ...
      },
      {
        ...
        "image": "img/gear/high-carbon-lure-rod.png?v=hc1",
        "nameKr": "하이카본 루어 낚싯대",
        "method": "루어",
    ...
    "reels": [
      ...
      {
        "tier": 2,
        "image": "img/gear/reel-t2.png?v=gear3",
      ...
      {
        "tier": 3,
        "image": "img/gear/reel-t3.png?v=gear3",
      ...
      {
        "tier": 4,
        "image": "img/gear/reel-t4.png?v=gear3",
      ...
      {
        "tier": 5,
        "image": "img/gear/reel-t5.png?v=gear3",
